...
namespace Globe.Account.Api
{
    public class Program
    {
        ...
        public static int Main(string[] args)
        {
            ...
            {
                Log.Fatal(ex, "An unhandled exception occurred during bootstrapping. Service {ServiceName} is Stopping now...", Configuration.GetSection("ServiceInformation").GetValue<string>("ServiceName"));
                if (logger != null)
                    logger.LogCritical(ex, "An unhandled exception occurred during bootstrapping. Service {ServiceName} is Stopping now...", Configuration.GetSection("ServiceInformation").GetValue<string>("ServiceName"));
                return 1;
            }
            finally
            {
